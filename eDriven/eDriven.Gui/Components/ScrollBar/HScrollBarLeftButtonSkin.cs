...
namespace eDriven.Gui.Components
{
    ...
    [Style(Name = "backgroundStyle", Type = typeof(GUIStyle), ProxyType = typeof(HScrollBarLeftButtonStyle))]

    public class HScrollBarLeftButtonSkin : Skin
    {
        #region Members
        ...
        ///<summary>
        ///</summary>
        public HScrollBarLeftButtonSkin()
        {
