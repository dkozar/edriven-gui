...
namespace eDriven.Gui.Components
{
    ...
    [Style(Name = "backgroundStyle", Type = typeof(GUIStyle), ProxyType = typeof(HScrollBarRightButtonStyle))]

    public class HScrollBarRightButtonSkin : Skin
    {
        #region Members
        ...
        ///<summary>
        ///</summary>
        public HScrollBarRightButtonSkin()
        {
