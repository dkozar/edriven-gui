...
namespace eDriven.Gui.Components.Rendering
{
    ///<summary>
    ///</summary>
    public class VScrollBarUpButtonStyle
    {
        ...
        public static GUIStyle Instance
        {
            get
            {
                if (_instance == null)
                {
                    //Debug.Log("Getting VScrollBarUpButtonStyle instance");
        ...
        private VScrollBarUpButtonStyle()
        {
        ...
        private static void Initialize()
        {
            ...
            ScrollbarHelper.ApplyButtonStyle(_style, Width, Weight, TriangleDirection.Up);
